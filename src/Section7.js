...
import SocialBanner from './images/5.webp'
    ...
    return (
        <div>
            <section className="section3 section4">
                ...
                <h2 className="section3__heading2 heading7">Pinterest Templates</h2>

                <div className="col-lg-12 mx-auto mt-5">
                  {blogcard.map((info) => (
                    <div className="blogcard col-lg-6 mx-auto" key={info.id} style={{padding: "10px" }} >
                      <div className="card section3__card card7  m-2 shadow">
